...
import 'package:permainan_matematika/pages/level/level-five.dart';

class LevelFourPage extends StatefulWidget {
  var score;
  LevelFourPage({super.key, this.score});
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                scale: 1.5,
                                image: AssetImage('assets/images/level-four-1.png'),
                              )),
                          child: Container(),
                        ),
                        SizedBox(height: 20),
                        Center(
                            child: Text(
                          'Bentuk pecahan dari bagian pizza yang sudah diambil adalah...',
                          textAlign: TextAlign.center,
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            if (_answerController.text.toString() != '1/3') {
                              _buildWrongDialog();
                            } else {
                              _buildCorrectDialog();
                            }
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                LevelFivePage(score: widget.score)));
                  },
                  child: Container(
                    width: MediaQuery.of(context).size.width,
                    height: 50,
